...
namespace TTNM
{
    public partial class SuaDiemGVBM : Form
    {
        ...
        public SuaDiemGVBM(string username, string hocsinhID, string hovaten, string lop, string monhoc, string diemso)
        {
            InitializeComponent();
        ...
        private void SuaDiemGVBM_Load(object sender, EventArgs e)
        {
