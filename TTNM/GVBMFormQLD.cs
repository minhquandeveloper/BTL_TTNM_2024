...
namespace TTNM
{
    public partial class GVBMFormQLD : Form
    {
        private string username;
        public GVBMFormQLD(string username)
        {
            InitializeComponent();
            this.username = username;
        }

        private void GVBMFormQLD_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            AddDiemGVBM addDiemGVBM = new AddDiemGVBM(username);
            addDiemGVBM.ShowDialog();
            this.Close();
        }
        ...
        {
            GVBMForm home = new GVBMForm(username);
            home.Show();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            SuaDiemGVBM editDiem = new SuaDiemGVBM(username, hocsinhID, hovaten, lop, monhoc, diemso);
            editDiem.Show();
        }
