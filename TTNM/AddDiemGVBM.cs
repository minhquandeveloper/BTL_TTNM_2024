...
namespace TTNM
{
    public partial class AddDiemGVBM : Form
    {
        private string username;

        public AddDiemGVBM(string username)
        {
            InitializeComponent();
            this.username = username;
        }

        private void AddDiemGVBM_Load(object sender, EventArgs e)
        {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
                ...
                {
                    MessageBox.Show("Điểm số không hợp lệ. Vui lòng nhập lại.");
                    return;
                }
