...
CREATE TABLE GVCN (
 ...
 FROM Lop
 LEFT JOIN GVCN ON Lop.id = GVCN.Lopchunhiem WHERE LOP.Tenlop like '%12%'
...
('HS01', 'Vũ Minh Quân', 'Nam', '2006-01-01', 1, '0912345678', '1', '2024-2025'), 
('HS02', 'Dương Thị Hồng Nhung', 'Nữ', '2006-02-02', 2, '0912345679', '1', '2024-2025'), 
('HS03', 'Đỗ Huy Hoàng', 'Nam', '2005-03-03', 3, '0912345680', '1', '2024-2025');

-- Thêm dữ liệu mẫu vào bảng BGH
INSERT INTO BGH (Mataikhoan, Hoten, Sdt) VALUES 
('BGH001', 'Trịnh Minh Thụ', '0912345681');
...
(N'Đỗ Huy Hoàng', '0912345683', '1980-04-04', 'Nữ', 'Hà Nội', 2, 3, 1),
(N'Dương Thị Hồng Nhung', '0912345689', '1980-04-04', 'Nữ', 'Hà Nội', 2, 4, 1);
